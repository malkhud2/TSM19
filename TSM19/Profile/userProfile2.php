...
$sql = "SELECT * FROM clubForm where userID='{$userID}' Limit 1";
...
echo"<div class='col-md-8 col-sm-6 col-xs-12 personal-info'>";
     echo "<div class='alert alert-info alert-dismissable'>";
      ...
      echo  "<i class='fa fa-coffee'></i>This is your <strong>Club</strong> Form.</div>";

        while($row = mysqli_fetch_array($result)){

echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         echo "<label class='col-lg-3 control-label'>Form ID:</label>";
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['clubFormID'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
      echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         echo "<label class='col-lg-3 control-label'>GPA:</label>";
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['clubName'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
           echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         echo "<label class='col-lg-3 control-label'>Post states:</label>";
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['clubPostDate'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
           echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         echo "<label class='col-lg-3 control-label'>Skills:</label>";
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['clubDescription'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
                 echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         echo "<label class='col-lg-3 control-label'>Skills:</label>";
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['clubEmail'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
    ...
    echo "<div class='form-group'>";
          ...
          echo "<div class='col-md-8'>";
            ...
            echo"<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Profile/userProfile.php'  class='btn btn-primary'> Your Profile </a></li>";
       echo   "</div>";
     echo   "</div>";
     echo   "</div>";
   echo   "</form>";
    ...
    echo "<div class='col-md-4 col-sm-6 col-xs-12'>";
        ...
        echo "<div class='form-group'>";
         ...
         echo "<div class='col-lg-8'>";
                ...
                echo "<h5>Our recored shows that you do Not have a Club Form.</h5>";
                
                echo "<div class='form-group'>";
          echo "<label class='col-md-8 control-label'></label>";
          echo "<div class='col-md-8'>";
            echo"<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Profile/userProfile1.php'  class='btn btn-primary'> Tutor Form </a></li>";
            echo"<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Profile/userProfile.php'  class='btn btn-primary'> Your Profile </a></li>";
       echo   "</div>";
