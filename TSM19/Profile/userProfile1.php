...
$sql = "SELECT * FROM tutorForm where userID='{$userID}' Limit 1";
...
echo"<div class='col-md-8 col-sm-6 col-xs-12 personal-info'>";
     echo "<div class='alert alert-info alert-dismissable'>";
      ...
      echo  "<i class='fa fa-coffee'></i>This is your <strong>Tutor</strong> Form.</div>";
...
echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         ...
         echo   "<input class='form-control' value=" . $row['tutorFormID'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
      echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         ...
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['tutorGPA'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
           echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         ...
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['tutorPostDate'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
           echo "<form class='form-horizontal' role='form'>";
        echo "<div class='form-group'>";
         ...
         echo "<div class='col-lg-8'>";
         echo   "<input class='form-control' value=" . $row['tutorSkills'] . " type='text'>";
         echo "</div>";
      echo  "</div>";
    echo "<div class='form-group'>";
...
echo"</div>";
  ...
  echo "<div class='row'>";
    echo "<div class='col-md-4 col-sm-6 col-xs-12'>";
        ...
        echo "<img src='http://malkhud2.create.stedwards.edu/TSM19/Images/reverME.png' width='300' height='300' class='img-circle'>";
echo "<form class='form-horizontal' role='form'>";
                echo "<h5>Our recored shows that you do Not have a Tutor Form.</h5>";
                echo "<div class='form-group'>";
          echo "<label class='col-md-3 control-label'></label>";
          echo "<div class='col-md-8'>";
            echo"<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Profile/userProfile.php'  class='btn btn-primary'> Your Profile </a></li>";
