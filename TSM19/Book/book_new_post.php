...
print    
    ...
    "    <div class='container'>\n".
      "<h2>New Book Ad </h2>\n".
 "<form method='post' action='book_new_post.php' enctype='multipart/form-data' >\n".
  ...
  "<div class='form-group'>\n".
      ...
      "<div class='form-group'>\n".
         "<label for='bookDescription'>Extra Info</label>\n".
       " <textarea class='form-control 'name='bookDescription' cols='30' rows='10'>\n".
        " </textarea>\n".
     " </div>\n".
      
          "<div class='form-group'>\n".
         "<label for='bookImage'>Post Image</label>\n".
          "<input type='file'  name='image'>\n".
      "</div>\n".
      
     "<div class='container'>\n".
    "<button type='submit' class='btn btn-primary' name='new_book'>Submit</button>\n".
     "<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Book/book.php' class='btn btn-danger'> Back </a></li>".
