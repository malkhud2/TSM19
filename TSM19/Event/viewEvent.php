...
if(isset($_GET['eventID']) && ($_GET['userID'])){
    $the_event_id = ($_GET['eventID']);
    $the_userID = ($_GET['userID']);
    
$sql = "select * FROM event, user where event.eventID=$the_event_id AND event.userID=$the_userID LIMIT 1";
...
echo"<div class='col-md-8 col-sm-6 col-xs-12 personal-info'>";
     echo "<div class='alert alert-info alert-dismissable'>";
      ...
      echo  "<i class='fa fa-coffee'></i>All Events are <strong>located</strong> on campus.</div>";
    ...
    echo "<div class='media-body'>\n";
     echo "<h4 class='media-heading'>Event ID:</h4>\n";
     echo "" . $row['eventID'] ."";
    echo  "</div>";
    echo "</br>\n";
    
    echo "<div class='media-body'>\n";
     echo "<h4 class='media-heading'>Event Title:</h4>\n";
     echo ""  . $row['eventTitle'] ."";
    echo  "</div>";
    echo "</br>\n";

    echo "<div class='media-body'>\n";
     echo "<h4 class='media-heading'>Event Date:</h4>\n";
     echo "" . $row['eventDate'] ."";
    echo  "</div>";
    echo "</br>\n";

    echo "<div class='media-body'>\n";
     echo "<h4 class='media-heading'>Event Post Date:</h4>\n";
     echo "" . $row['eventPostDate'] ."";
    echo  "</div>";
    echo "</br>\n";

     echo "<div class='media-body'>\n";
     echo "<h4 class='media-heading'>Event Description:</h4>\n";
     echo "" . $row['eventDescription'] ."";
    echo  "</div>";
        echo "</br>\n";
        
            echo "<div class='media-body'>\n";
     echo "<h4 class='media-heading'>Event Post:</h4>\n";
     echo "<img src='eventImg/".$row['eventImage']."' style='width:500px'>";
    echo  "</div>";
        echo "</br>\n";
  ...
  echo  "</div>";
                    ...
                    echo "</br>";
                    echo "<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Event/event.php' class='btn btn-danger'> Back </a></li>";
