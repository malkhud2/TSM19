...
print    
    ...
    "    <div class='container'>\n".
      "<h2>New Event</h2>\n".
 "<form method='post' action='event_new_post.php' enctype='multipart/form-data' >\n".
  ...
  "<div class='form-group'>\n".
      ...
      "<div class='form-group'>\n".
         "<label for='eventDescription'>Extra Info</label>\n".
       " <textarea class='form-control 'name='eventDescription' cols='30' rows='10'>\n".
        " </textarea>\n".
     " </div>\n".
      
          "<div class='form-group'>\n".
         "<label for='eventImage'>Post Image</label>\n".
          "<input type='file'  name='image'>\n".
      "</div>\n".
      
     "<div class='container'>\n".
    "<button type='submit' class='btn btn-primary' name='new_event'>Submit</button>\n".
     "<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Event/event.php' class='btn btn-danger'> Back </a></li>".
