...
if($result = mysqli_query($conn, $sql)){
   ...
   echo "<div class='container'>";
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<tr>";
                echo "<td>" . $row['tutorFormID'] . "</td>";
                echo "<td>" . $row['tutorGPA'] . "</td>";
                echo "<td>" . $row['tutorPostDate'] . "</td>";
                echo "<td>" . $row['tutorSkills'] . "</td>";
                echo "<td>"."<a href='upTutor.php?approve=$tutorFormID'>Approve</a>"."</td>";
                echo "<td>"."<a href='upTutor.php?reject=$tutorFormID'>Reject</a>"."</td>";
            echo "</tr>";
