...
print    
    ...
    "    <div class='container'>\n".
      "<h2> Club Ad </h2>\n".
 "<form method='post' action='club_new_post.php' enctype='multipart/form-data' >\n".
    ...
    "<button type='submit' class='btn btn-primary' name='new_club'>Submit</button>\n".
     "<li> <a href='http://malkhud2.create.stedwards.edu/TSM19/Club/club.php' class='btn btn-danger'> Back   </a></li>".
    "</div>\n".
