...
print    
 ...
 "<form method='post' action='tutorForm.php' >\n".
    ...
    "<div class='form-group'>\n".
      "<label for='tutorGPA'>What is your GPA? </label>\n".
      "<input type='text' class='form-control'  name='tutorGPA' style='height:50px'>\n".
      "</div>\n".
      
       "<div class='form-group'>\n".
      "<label for='tutorSkills'>Why do you want to become a Tutor?</label>\n".
      " <textarea class='form-control 'name='tutorSkills'  cols='30' rows='10'>\n".
     " </textarea>\n".
      "</div>\n".
