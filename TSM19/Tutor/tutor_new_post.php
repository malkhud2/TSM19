...
print    
 ...
 "<form method='post' action='tutor_new_post.php' >\n".
      ...
      "<label for='tutoringDate'>Date:</label>\n".
      "<input type='date' class='form-control'   name='tutoringDate' style='height:50px'>\n".
      "</div>\n".


    "<div class='form-group'>\n".
      "<label for='tutoringTime'>Time:</label>\n".
      "<input type='time' class='form-control'   name='tutoringTime' style='height:50px'>\n".
      "</div>\n".
                
    "<div class='form-group'>\n".
      "<label for='tutoringCourse'>Course:</label>\n".
      "<input type='text' class='form-control'   name='tutoringCourse' style='height:50px'>\n".
      "</div>\n".
      
       "<div class='form-group'>\n".
      "<label for='tutoringLocation'>Location:</label>\n".
      "<input type='text' class='form-control'  name='tutoringLocation' style='height:50px'>\n".
      "</div>\n".
      
      "<div class='form-group'>\n".
      "<label for='tutoringDuration'>Duration:</label>\n".
      "<input type='time' class='form-control'  name='tutoringDuration' style='height:50px'>\n".
      "</div>\n".
                "</div>\n".
   
    "<div class='container'>\n".
    "<button type='submit' class='btn btn-primary' name='new_tutor'>Request Tutor</button>\n".
